...
export const COL_SCHEDULE_EVENTS =
  import.meta.env.APPWRITE_COLLECTION_SCHEDULE_EVENTS_ID ??
  import.meta.env.APPWRITE_COLLECTION_OFFERING_SLOTS_ID;
// Legacy alias kept to avoid breaking modules not migrated yet.
export const COL_OFFERING_SLOTS = COL_SCHEDULE_EVENTS;
...
export const COL_OFFERING_AVAILABILITY_RULES =
  import.meta.env.APPWRITE_COLLECTION_OFFERING_AVAILABILITY_RULES_ID;
export const COL_OFFERING_DAILY_INVENTORY =
  import.meta.env.APPWRITE_COLLECTION_OFFERING_DAILY_INVENTORY_ID;

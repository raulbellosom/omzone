---
description: Agregar o actualizar traducciones ES/EN en los namespaces del proyecto
---

# i18n Content — OMZONE

Agrega o actualiza las traducciones descritas a continuación.
...
- Default language: `es` (fallback siempre español)
- Supported: `es`, `en`

---
description: Construir páginas CRUD del panel admin con tablas, formularios y acciones
---

# Admin CRUD — OMZONE

Construye la página CRUD de admin descrita a continuación siguiendo las convenciones del proyecto.
...
The project is in **Phase 5 — Panel admin (Frontend)**. All admin pages use mock data via `useAdmin*` hooks. The service layer follows the mock → Appwrite migration pattern.
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing ? t("entity.editDescription") : t("entity.createDescription")}
          </DialogDescription>
        </DialogHeader>
